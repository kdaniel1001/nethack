 ...
 */
STATIC_OVL void expulsion(seal)
    boolean seal;
{
    branch *br;
    d_level *dest;
...
STATIC_OVL void prisoner_speaks(mtmp)
    struct monst *mtmp;
{
