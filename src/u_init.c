...
STATIC_OVL void knows_object(obj)
    register int obj;
{
 ...
 */
STATIC_OVL void knows_class(sym)
    register char sym;
{
    register int ct;
...
STATIC_OVL boolean restricted_spell_discipline(otyp)
    int otyp;
{
    ...
    register struct trobj *trop;
{
    ...
    while (trop->trclass)
    {
        ...
        { /* UNDEF_TYP */
            ...
            otyp = obj->otyp;
            while (otyp == WAN_WISHING || otyp == nocreate || otyp == nocreate2
        ...
        else
        {
            ...
            obj->cursed = 0;
            if (obj->opoisoned && u.ualign.type != A_CHAOTIC) obj->opoisoned =
                    0;
        ...
        if (obj->oclass == WEAPON_CLASS
                || is_weptool(
                        obj) || otyp == TIN_OPENER || otyp == FLINT || otyp == ROCK)
        {
