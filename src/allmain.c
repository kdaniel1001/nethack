    ...
    boolean resuming;
{
    ...
    for (;;)
    {
        ...
        if (context.move)
        {
            ...
            { /* hero can't move this turn loop */
                ...
                if (!monscanmove && youmonst.movement < NORMAL_SPEED)
                {
                    ...
                    {
                        u.uen += rn1(
                                (int) (ACURR(A_WIS) + ACURR(A_INT)) / 15 + 1,
                                1);
                    ...
                    if (!u.uinvulnerable)
                    {
                        ...
                        if ((change == 1 && !Polymorph)
                                || (change == 2 && u.ulycn == NON_PM)) change =
                                0;
                        if (Polymorph && !rn2(100))
                            change = 1;
                        else if (u.ulycn >= LOW_PM && !Upolyd
                                && !rn2(80 - (20 * night()))) change = 2;
        ...
        if (!context.mv || Blind)
        {
            ...
            else if (Warning || Warn_of_mon) see_monsters();
        ...
        if (multi > 0)
        {
            ...
            if (context.mv)
            {
                if (multi < COLNO && !--multi) context.travel =
                        context.travel1 = context.mv = context.run = 0;
                domove();
            }
            else
            {
        ...
        else if (flags.time && (!context.move || !context.mv)) context.botl = 1;
