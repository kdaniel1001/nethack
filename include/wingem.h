...
E void
NDECL(mar_reverse_menu);
E void FDECL(mar_set_menu_title, (const char *));
E void
NDECL(mar_set_accelerators);
...
E void
NDECL(Gem_update_inventory);
E void
NDECL(Gem_mark_synch);
E void
NDECL(Gem_wait_synch);
#ifdef CLIPPING
...
E void
NDECL(Gem_start_screen);
E void
NDECL(Gem_end_screen);
