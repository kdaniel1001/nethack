...
#define TA_INHIBIT_VERT_SCROLL 16L
     ...
     */
    TTY_ATTRIB_FOREGROUND, TTY_ATTRIB_BACKGROUND,
 ...
 */
extern short
set_tty_font_name(winid window_type, char *name);
extern short
 ...
 */
extern short
clear_tty_window(WindowPtr window, short from_row, short from_col, short to_row,
        short to_col);
