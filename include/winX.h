...
E void
NDECL(null_out_status);
E void
NDECL(check_turn_events);
...
E void
NDECL(X11_update_inventory);
E void
NDECL(X11_mark_synch);
E void
NDECL(X11_wait_synch);
#ifdef CLIPPING
