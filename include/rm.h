...
struct symsetentry
{
    ...
    Bitfield(rogue, 1);
    /* restricted for use as rogue lev set  */
    /* 5 free bits */
};
...
struct rm
{
    ...
    Bitfield(candig, 1);
    /* Exception to Can_dig_down; was a trapdoor */
};
...
struct levelflags
{
    ...
    Bitfield(has_shop, 1);Bitfield(has_vault, 1);Bitfield(has_zoo, 1);Bitfield(has_court, 1);Bitfield(has_morgue, 1);Bitfield(has_beehive, 1);Bitfield(has_barracks, 1);Bitfield(has_temple, 1);

    Bitfield(has_swamp, 1);Bitfield(noteleport, 1);Bitfield(hardfloor, 1);Bitfield(nommap, 1);Bitfield(hero_memory, 1); /* hero has memory */
    ...
    Bitfield(is_maze_lev, 1);Bitfield(is_cavernous_lev, 1);Bitfield(arboreal, 1); /* Trees replace rock */
    ...
    Bitfield(corrmaze, 1);
    /* Whether corridors are used for the maze
     rather than ROOM */
};
