...
E void
NDECL(term_start_raw_bold);
E void
NDECL(term_end_raw_bold);
...
E void
NDECL(tty_update_inventory);
E void
NDECL(tty_mark_synch);
E void
NDECL(tty_wait_synch);
#ifdef CLIPPING
...
E void
NDECL(tty_start_screen);
E void
NDECL(tty_end_screen);
