...
E void
NDECL(stop_occupation);
E void
NDECL(display_gamewindows);
E void
NDECL(newgame);
...
E void
NDECL(add_debug_extended_commands);
...
E void
NDECL(buried_ball_to_punishment);
E void
NDECL(buried_ball_to_freedom);
...
E void
NDECL(init_r_symbols);
E void
NDECL(init_symbols);
E void
NDECL(update_bouldersym);
E void
NDECL(init_showsyms);
E void
NDECL(init_l_symbols);
...
E void
NDECL(makeroguerooms);
E void FDECL(corr, (int, int));
E void
NDECL(makerogueghost);
...
E void
NDECL(light_sources_sanity_check);
...
E void
NDECL(reglyph_darkroom);
E boolean FDECL(match_optname, (const char *, const char *, int, BOOLEAN_P));
E void
NDECL(initoptions);
E void
NDECL(initoptions_init);
E void
NDECL(initoptions_finish);
...
E void
NDECL(free_autopickup_exceptions);
...
E void
NDECL(shopper_financial_report);
...
E void
NDECL(sys_early_init);
E void
NDECL(sysopt_release);
